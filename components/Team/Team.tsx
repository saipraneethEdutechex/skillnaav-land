          ...
          <Carousel.Item key={index}>
            <div className="card">
              ...
              <div className="card-body">
                <h5 className="card-title">{teamMembers[index].name}</h5>
                <p className="card-text">{teamMembers[index].position}</p>
                <p className="card-text">{teamMembers[index].description}</p>
                <ul className="list-group">
                  {teamMembers[index].points.map((point, i) => (
